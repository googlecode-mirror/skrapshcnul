...
<div>Total records: <?php echo isset($results['events_past_count']) ? $results['events_past_count'] : 0;?></div>

<div>
	<?php if (!empty($results['events_past'])) { ?>
		
		<?php foreach($results['events_past'] as $event) { ?>
