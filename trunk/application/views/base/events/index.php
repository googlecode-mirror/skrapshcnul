<div class="m-content">
	<div class="c-pages shadow-rounded">
		...
		<div class="hr">
			<h2 class="hr-text">Suggestions</h2>		
		</div>
		...
		<div class="box-details">
			<?php if(!empty($events['auto_recommendation'])) { ?>
				...
				<?php }?>
			<?php } else { ?>
				<div class="no-result-message">You have no recommendation.</div>
			<?php }?>
		</div>
		...
		<div class="box-details">
			...
			<?php } else { ?>
				...
				<div class="no-result-message">You have no upcoming event.</div>
		...
		<div class="box-details">
			...
			<?php if(!empty($events['past_events'])) { ?>
				...
				<?php } ?>
			<?php } else { ?>
				<div class="no-result-message">You have no past event.</div>
			<?php }?>
		</div>
	</div>
	<div class="clearfix">&nbsp;</div>
